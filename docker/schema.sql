...
--
-- Print reliability + audit log (supabase/migrations/010_print_reliability_and_logging.sql).
-- The unique index stops a double-click / retried request from queuing a
-- second active print job for the same order+station+type; print_log is an
-- append-only trail of every queue/print/skip/reclaim event for the admin
-- Printing page.
--
